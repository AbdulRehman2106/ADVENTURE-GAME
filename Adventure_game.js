...
console.log(chalk_1.default.rgb(127, 255, 0)("\n\t\tWELCOME TO DEADZONE"));
game: while (gameRunning) {
    ...
    while (enemyHealth > 0) {
        console.log(chalk_1.default.rgb(238, 232, 170)(`\nYOUR HEALTH  ${heroHealth}`));
        console.log(chalk_1.default.rgb(0, 128, 128)(`\n${enemy}  ENEMY HEALTH : ${enemyHealth}\n`));
        let prompt = await inquirer_1.default.prompt({
            name: "ans",
            type: "list",
    ...
    if (userOption.ans === "1. CONTINUE") {
        console.log(chalk_1.default.rgb(64, 224, 208)(`\nYOU CONTINUE ON YOUR ADVENTURE\n`));
    }
    else {
        console.log(chalk_1.default.rgb(100, 149, 237)(`\n YOU SUCCESSFULLY EXIT FROM DEADZONE\n`));
        break;
